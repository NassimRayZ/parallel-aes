...
// to change the number of rounds, change the value of key  variablie in the main function please
...
{
    int expanded_key_size = (NUMBER_OF_ROUNDS + 1) * SIZE_16;
    ...
    printf("Implementation of AES encryption using C/OPENMP\n");
...
#pragma omp parallel for num_threads(NUMBER_OF_THREADS)
    ...
    printf("Time used in CPU/OPENMP mode: %f\n\n", cpu_time_used);
